...
import tech.smartboot.mqtt.plugin.openapi.to.MessageTO;
...
public class AiController {
    ...
    public void chat(HttpRequest request, @Param("messages") List<MessageTO> messages) throws IOException {
...
//                .tool(new SearchTool())
                ...
                .baseUrl(openAI.getUrl())
                .model(openAI.getModel()).apiKey(openAI.getApiKey()));
