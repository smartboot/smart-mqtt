...
## v1.6.0（2026-06-06）
- smart-socket upgraded to 2.0.0
- Feat upgraded to 2.1.0
- Optimized RetainMessage memory usage
- Updated built-in trial license

> This version is an incompatible upgrade. It is recommended to verify the compatibility of existing environments and custom plugins before upgrading.

Release Details: [smart-mqtt v1.6.0: In the AI Era, Where Are the Boundaries of a One-Person Product?](https://mp.weixin.qq.com/s/QFw6auvPrqTK3YRiwdtdCg)
